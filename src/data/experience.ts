...
export const experience: Experience[] = [
  {
    ...
    description: `Worked as Software Engineer for multiple large teams developing software to help advanced a premier mortgage lender.
    \nCollaborate with cross-functional teams, including designers, project managers, stakeholders, and other developers, to deliver high-quality solutions.
    \nBuilt and maintained a Large scale multitenant applications with users all across the country.`,
    company: `Lima One Capital`,
    url: `https://limaonecapital.com/`,
  },
